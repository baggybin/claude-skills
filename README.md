...
| [`bug_hunt`](skills/bug_hunt/SKILL.md) | — | Verified swarm code review: mechanically cross-checked search space, nine read-only hunter personas, POSITIVE/NEGATIVE claim discipline, and a falsification pass where a different model family must break headline findings before they ship. |
